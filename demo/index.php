            ...
            <div class="row align-items-center mb-30-none">
                <div class="col-lg-8 mb-30">
                    <div class="banner-content">
                        ...
                        <span class="sub-title" data-i18n="indexsubtitle">En seulement 10 questions, notre algorithme vous propose une liste de jeux adaptée à vos envies parmis les 130 000 disponibles.</span>
            ...
            <div class="row justify-content-center align-items-center mb-30-none">
                        ...
                        <div class="row justify-content-center mb-30-none">
                            ...
                            <div class="col-lg-6">
                                <div class="about-item about-item--style text-center mt-30">
                                    ...
                                    <h3 class="title" data-i18n="index_bloc_2_title">Une expérience sans égal</h3>
                                    <p  data-i18n="index_bloc_2_p"> Faîtes vous plaisir sur le jeu qui vous correspond parmis les 130 000 disponibles. </p>
                                   </div>
                            </div>
                            <div class="col-lg-6 mb-30">
                                <div class="about-item text-center">
                                    ...
                                    <p  data-i18n="index_bloc_3_p">Un outil poussé fournissant une nouvelle approche de la consommation vidéoludique. </p>
                                </div>
                            </div>
                            <div class="col-lg-6 mb-30">
                                <div class="about-item about-item--style-two text-center mt-30">
                                    ...
                                    <p  data-i18n="index_bloc_4_p">Parceque nous aussi nous avons passé trop de temps à chercher un bon jeu. </p>
                                   </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 mb-30">
                    <div class="about-content">
                        ...
                        <p> Découvrez ou redécouvrez des licences que vous avez ratées, indépendantes ou proposant des jeux AAA qui correspondent à votre envie, qui est, à notre sens, unique.</p>
